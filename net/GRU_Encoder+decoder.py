...
class BST(paddle.nn.Layer):
    def __init__(self, user_count, item_emb_size, cat_emb_size,
        ...
        # Transformer encoder
        self.decoder_layer = paddle.nn.TransformerDecoderLayer(self.d_model, self.n_head, self.d_inner_hid)

        self.transformer_block = paddle.nn.TransformerDecoder(self.decoder_layer, 1)
